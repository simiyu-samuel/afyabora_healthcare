...
<head>
	...
	<link rel="shortcut icon" type="image/x-icon" href="images/ambulance.png" />
...
<nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav" >
    <div class="container">
      ...
      <a class="navbar-brand js-scroll-trigger" href="#" style="margin-top: 10px;margin-left:-65px;font-family: 'IBM Plex Sans', sans-serif;"><h4><i class="fa fa-plus" aria-hidden="true"></i>&nbsp AFYA BORA HEALTHCARE</h4></a>
...
<div class="container register" style="font-family: 'IBM Plex Sans', sans-serif;">
                <div class="row">
                    <div class="col-md-3 register-left" style="margin-top: 10%;right: 5%">
                        ...
                        <h3>Welcome</h3>
                        <div class="dispatch">
                            <a href="ambulance-dispatch/frontend/index.php">Request Ambulance</a>
                        </div>
