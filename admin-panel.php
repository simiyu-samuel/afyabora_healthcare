...
if(isset($_GET["generate_bill"])){
  ...
  $content .= '
      <br/>
      <h2 align ="center"> Afya Bora Healthcare</h2></br>
...
<html lang="en">
  ...
  <a class="navbar-brand" href="#"><i class="fa fa-user-plus" aria-hidden="true"></i> AFYA BORA HEALTHCARE </a>
...
.btn-primary{
  ...
  <?php
  include('healthcare_ai/views/chatbot.php');
  ?>
